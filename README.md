...
| `LLM_API_KEY` | – | API key for LLM-powered summarization (OpenAI-compatible) |
| `LLM_MODEL` | `gpt-4o-mini` | LLM model to use for summarization |
| `LLM_BASE_URL` | `https://api.openai.com/v1` | Base URL for the LLM API (change for alternative providers) |
...
local-service/
  src/
    ...
    summarizer/           # Rule-based and LLM-powered summarization
